    ...
    try:
        ...
        for attachment in os.listdir(attachments_dir):
            if attachment.startswith('U80.0.0 Список изменений'):
                ...
                bot_info_logger.info("Удален старый файл: %s", attachment)
                ...
                for item in items:
                    ...
                    if 'U80.0.0 Список изменений' in item_name and f'{version}.pdf' in item_name:
                        ...
                        try:
                            ...
                            bot_info_logger.info("Скачан новый файл: %s", item_name)
                            ...
                            bot_error_logger.error("Ошибка при скачивании файла %s: %s", item_name, error)
