...
class ButtonClients():
    ...
    def button_clients_version():
        ...
        button_clients_version.add(button_version_main_list, button_version, row_width=1)
    ...
    def button_templates():
        ...
        button_templates.add(button_tele2, button_psb, button_rez, button_pochtaR, row_width=1)
